...
class MigrationRunner {
    ...
    async getAppliedMigrations() {
        const result = await this.pool.query('SELECT filename FROM migrations.applied_migrations ORDER BY id');
    ...
    async runMigration(filename) {
        ...
        try {
            ...
            await this.pool.query('INSERT INTO migrations.applied_migrations (filename) VALUES ($1)', [filename]);
